...
class NotebookProcessor:
    ...
    def extract_imports(self, notebook_paths: List[str]) -> Dict[str, List[str]]:
        ...
        self.logger.info(f"Processing {len(unique_notebooks)} unique notebooks for imports")
    ...
    def _process_directory_entry(self, entry: dict, repo_dir: Path, root_nb_directory: str) -> List[str]:
